                                ...
                                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                                    {availableDonations.map((availableDonation, i) => (
                                        <button
                                            ...
                                            className={` rounded-xl cursor-pointer flex flex-col items-center justify-center p-5 ${selectedDonation?.value == availableDonation.value ? "border-[2.5px] border-blue-600" : ""}`}
                            ...
                            {selectedDonation?.value == "lainnya" ? (
                                <div className="relative">
                                    <input
                                        type="text"
                                        name="custom_price"
                                        className="text-right w-full mt-4 border-[0.5px] p-3 rounded focus:outline-blue-400 text-gray-700 text-xl font-semibold placeholder:font-normal placeholder:text-lg placeholder:text-gray-400 font-inter border-gray-300"
                        ...
                        <button className="bg-white rounded font-inter text-sm text-blue-500 border-[1px] border-blue-600 py-1.5 px-6 flex justify-center gap-x-0.5 items-center">
                            ...
                            {!checkedHideName ? (
                                <div className="mt-6">
                                    <input
                                        ...
                                        name="fullname"
                                        id="fullname"
                                        className="border-[0.5px] border-gray-300 rounded w-full px-4 text-sm focus:outline-blue-400 font-inter py-3"
                            ...
                            <div className="mt-4">
                                <textarea
                                    ...
                                    className="h-[120px] border-[0.5px] border-gray-300 rounded w-full px-4 text-sm focus:outline-blue-400 font-inter py-3"
