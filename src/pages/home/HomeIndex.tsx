...
export default function HomeIndex() {
    ...
    return (
        <div className="bg-[#EDF0F5] h-full py-4">
            ...
            <main className={`antialiased bg-[rgba(0, 0, 0, 0.4)] text-gray-900 font-sans overflow-x-hidden fixed w-full top-0 z-50 ${modalShareOpen ? '' : 'hidden'}`}>
                <div className="relative px-4 min-h-screen md:flex md:items-center md:justify-center">
                    ...
                    <div className="bg-white rounded-lg w-3/12 p-5 fixed inset-x-0 bottom-0 z-50 mb-4 mx-4 md:relative">
            ...
            <div className="mx-auto w-[525px]">
                <div>
                    ...
                    <div className="p-5 bg-white rounded-b-md shadow-lg">
                        ...
                        <div className="mt-6">
                            <button className="bg-blue-600 shadow-md w-full rounded-md text-center text-white font-inter font-semibold py-2">Donasi Sekarang!</button>
                        </div>
                    </div>
                    <div className="p-5 rounded-md bg-white shadow-lg mt-5">
                    ...
                    <div className="p-5 rounded-md bg-white shadow-lg mt-5 fixed w-[525px] bottom-0">
                        <div className="flex items-center gap-x-2">
                            <button type="button" onClick={() => {
                                setModalShareOpen(true)
                            }} className="flex-[2.5] flex items-center justify-center gap-x-2 border-[3px] border-blue-600 py-1.5 rounded-md">
                            ...
                            <button className="flex-[5] self-stretch rounded-md text-white font-inter font-semibold bg-blue-600 text-sm">
                                Donasi Sekarang
                            </button>
                        </div>
                    </div>
